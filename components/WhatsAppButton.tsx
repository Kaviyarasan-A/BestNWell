  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {showTip && !dismissed && (
          <motion.div
            ...
            className="relative glass-card rounded-2xl px-4 py-3 max-w-[260px] shadow-2xl mr-1"
          >
            <button
              aria-label="Dismiss"
              onClick={() => {
            ...
            <div className="text-xs text-emerald-300 font-semibold uppercase tracking-wider mb-1">
              💬 Quick chat
            </div>
            <div className="text-sm text-white/90 leading-snug">
              Hi! Got a project idea? <br />
              Tap to message us instantly on WhatsApp.
            </div>
            <div className="absolute -bottom-2 right-6 w-4 h-4 bg-white/[0.05] border-r border-b border-white/10 rotate-45" />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center shadow-[0_0_30px_rgba(34,197,94,0.5)] group"
      >
